...
Vector3f FTC_MPU6050::Get_Gyro_in_dps(Vector3f GyroRaw)
{
	Gyro_dps.x = radians(GyroRaw.x * MPU6050G_s2000dps);   // dps
	Gyro_dps.y = radians(GyroRaw.y * MPU6050G_s2000dps);   // dps
	Gyro_dps.z = radians(GyroRaw.z * MPU6050G_s2000dps);   // dps	
	return Gyro_dps;
}
